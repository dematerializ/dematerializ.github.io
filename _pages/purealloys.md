...
In the first publication of _PureAlloys_ {% cite SPATHARA2026170970 %}, simulations using computational thermodynamics are compared with experimental data for the first time. A materials-design approach is proposed for optimising the the manufacturing stages of both fabrication and thermal processing.
